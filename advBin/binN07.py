...
#---------------------------------------''')
print('✅' * 50)
import tkinter as tk                # python 374
from tkinter import font  as tkfont # python 374
import io
...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self,bd=8, text="Gerenciador de Telas --> BinN07 ",bg='GOLDENROD',font=controller.title_font)
...
class PageOne(tk.Frame):
    ...
    def helpForm(self):
        vet = []
        arqv = 'N:\\app_area_pycharmDB\\adv_bin\SQL1.txt'
        if arqv != '':
            with open(arqv) as f:
                for i in f:
                    vet.append(i)
