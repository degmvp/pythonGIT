...
r0 = Radiobutton(ventana,bg='GOLDENROD', text='M0',value='Clicou! M0', variable = relStatus)
r0['command'] = partial(bt_click,r0)
r0.place(x=150,y=80)

r1 = Radiobutton(ventana,bg='GOLDENROD', text='M1',value='Clicou! M1', variable = relStatus) 
r1['command'] = partial(bt_click,r1)
r1.place(x=150,y=110)

r2 = Radiobutton(ventana,bg='GOLDENROD', text='M2',value='Clicou! M2', variable = relStatus)
r2['command'] = partial(bt_click,r2)
r2.place(x=150,y=140)

r3 = Radiobutton(ventana,bg='GOLDENROD', text='M3',value='Clicou! M3', variable = relStatus)
r3['command'] = partial(bt_click,r3)
r3.place(x=150,y=170)

r4 = Radiobutton(ventana,bg='FOREST GREEN', text='M4',value='Clicou! M4', variable = relStatus)
r4['command'] = partial(bt_click,r4)
r4.place(x=200,y=80)

r5 = Radiobutton(ventana,bg='FOREST GREEN', text='M5',value='Clicou! M5', variable = relStatus)
r5['command'] = partial(bt_click,r5)
r5.place(x=200,y=110)

r6 = Radiobutton(ventana,bg='FOREST GREEN', text='M6',value='Clicou! M6', variable = relStatus)
r6['command'] = partial(bt_click,r6)
r6.place(x=200,y=140)

r7 = Radiobutton(ventana,bg='FOREST GREEN', text='M7',value='Clicou! M7', variable = relStatus)
r7['command'] = partial(bt_click,r7)
r7.place(x=200,y=170)

r8 = Radiobutton(ventana,bg='FOREST GREEN', text='M08',value='Clicou! M08', variable = relStatus)
r8['command'] = partial(bt_click,r8)
r8.place(x=250,y=80)

r9 = Radiobutton(ventana,bg='FOREST GREEN', text='M09',value='Clicou! M9', variable = relStatus)
r9['command'] = partial(bt_click,r9)
r9.place(x=250,y=110)

r10 = Radiobutton(ventana,bg='FOREST GREEN', text='M10',value='Clicou! M10', variable = relStatus)
r10['command'] = partial(bt_click,r10)
r10.place(x=250,y=140)

r11 = Radiobutton(ventana,bg='FOREST GREEN', text='M11',value='Clicou! M11', variable = relStatus)
r11['command'] = partial(bt_click,r11)
r11.place(x=250,y=170)

r12 = Radiobutton(ventana,bg='GOLDENROD', text='M12',value='Clicou! M12', variable = relStatus)
r12['command'] = partial(bt_click,r12)
r12.place(x=315,y=80)

r13 = Radiobutton(ventana,bg='GOLDENROD', text='M13',value='Clicou! M13', variable = relStatus)
r13['command'] = partial(bt_click,r13)
r13.place(x=315,y=110)

botonGuardar     = Radiobutton(ventana,text='Save',bg='red',command=guardar)
...
botonEliminar    = Radiobutton(ventana,text='Delete', command=eliminar,bg='yellow')
botonEliminar.place(x=470,y=80)

bot1             = Radiobutton(ventana,text='Select', command=ver,bg='yellow')
bot1.place(x=470,y=115)

bot2             = Radiobutton(ventana,text='Shutdown', command=fim,bg='yellow')
bot2.place(x=470,y=145)

r14 = Radiobutton(ventana,bg='red', text='MIX',command=mix)
